...
class ios_base(object):
    ...
    def register_callback(self, *args) -> "void" : return inlib_swig_py.ios_base_register_callback(self, *args)
    def flags(self, *args) -> "std::ios_base::fmtflags" : return inlib_swig_py.ios_base_flags(self, *args)
    def setf(self, *args) -> "std::ios_base::fmtflags" : return inlib_swig_py.ios_base_setf(self, *args)
    def unsetf(self, *args) -> "void" : return inlib_swig_py.ios_base_unsetf(self, *args)
    def precision(self, *args) -> "std::streamsize" : return inlib_swig_py.ios_base_precision(self, *args)
    def width(self, *args) -> "std::streamsize" : return inlib_swig_py.ios_base_width(self, *args)
    sync_with_stdio = staticmethod(inlib_swig_py.ios_base_sync_with_stdio)
    def imbue(self, *args) -> "std::locale" : return inlib_swig_py.ios_base_imbue(self, *args)
    def getloc(self) -> "std::locale" : return inlib_swig_py.ios_base_getloc(self)
    xalloc = staticmethod(inlib_swig_py.ios_base_xalloc)
    def iword(self, *args) -> "long &" : return inlib_swig_py.ios_base_iword(self, *args)
    def pword(self, *args) -> "void *&" : return inlib_swig_py.ios_base_pword(self, *args)
...
class ios(ios_base):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def rdstate(self) -> "std::ios_base::iostate" : return inlib_swig_py.ios_rdstate(self)
    def clear(self, *args) -> "void" : return inlib_swig_py.ios_clear(self, *args)
    def setstate(self, *args) -> "void" : return inlib_swig_py.ios_setstate(self, *args)
    def good(self) -> "bool" : return inlib_swig_py.ios_good(self)
    def eof(self) -> "bool" : return inlib_swig_py.ios_eof(self)
    def fail(self) -> "bool" : return inlib_swig_py.ios_fail(self)
    def bad(self) -> "bool" : return inlib_swig_py.ios_bad(self)
    def exceptions(self, *args) -> "void" : return inlib_swig_py.ios_exceptions(self, *args)
    def __init__(self, *args): 
    ...
    __del__ = lambda self : None;
    def tie(self, *args) -> "std::basic_ostream< char,std::char_traits< char > > *" : return inlib_swig_py.ios_tie(self, *args)
    def rdbuf(self, *args) -> "std::basic_streambuf< char,std::char_traits< char > > *" : return inlib_swig_py.ios_rdbuf(self, *args)
    def copyfmt(self, *args) -> "std::basic_ios< char > &" : return inlib_swig_py.ios_copyfmt(self, *args)
    def fill(self, *args) -> "std::basic_ios< char >::char_type" : return inlib_swig_py.ios_fill(self, *args)
    def imbue(self, *args) -> "std::locale" : return inlib_swig_py.ios_imbue(self, *args)
    def narrow(self, *args) -> "char" : return inlib_swig_py.ios_narrow(self, *args)
    def widen(self, *args) -> "std::basic_ios< char >::char_type" : return inlib_swig_py.ios_widen(self, *args)
...
class ostream(ios):
    ...
    __del__ = lambda self : None;
    def __lshift__(self, *args) -> "std::basic_ostream< char,std::char_traits< char > > &" : return inlib_swig_py.ostream___lshift__(self, *args)
    def put(self, *args) -> "std::basic_ostream< char,std::char_traits< char > > &" : return inlib_swig_py.ostream_put(self, *args)
    def write(self, *args) -> "std::basic_ostream< char,std::char_traits< char > > &" : return inlib_swig_py.ostream_write(self, *args)
    def flush(self) -> "std::basic_ostream< char,std::char_traits< char > > &" : return inlib_swig_py.ostream_flush(self)
    def tellp(self) -> "std::basic_ostream< char >::pos_type" : return inlib_swig_py.ostream_tellp(self)
    def seekp(self, *args) -> "std::basic_ostream< char,std::char_traits< char > > &" : return inlib_swig_py.ostream_seekp(self, *args)
...
class istream(ios):
    ...
    __del__ = lambda self : None;
    def __rshift__(self, *args) -> "std::basic_istream< char,std::char_traits< char > > &" : return inlib_swig_py.istream___rshift__(self, *args)
    def gcount(self) -> "std::streamsize" : return inlib_swig_py.istream_gcount(self)
    def get(self, *args) -> "std::basic_istream< char,std::char_traits< char > > &" : return inlib_swig_py.istream_get(self, *args)
    def getline(self, *args) -> "std::basic_istream< char,std::char_traits< char > > &" : return inlib_swig_py.istream_getline(self, *args)
    def ignore(self, *args) -> "std::basic_istream< char,std::char_traits< char > > &" : return inlib_swig_py.istream_ignore(self, *args)
    def peek(self) -> "std::basic_istream< char >::int_type" : return inlib_swig_py.istream_peek(self)
    def read(self, *args) -> "std::basic_istream< char,std::char_traits< char > > &" : return inlib_swig_py.istream_read(self, *args)
    def readsome(self, *args) -> "std::streamsize" : return inlib_swig_py.istream_readsome(self, *args)
    def putback(self, *args) -> "std::basic_istream< char,std::char_traits< char > > &" : return inlib_swig_py.istream_putback(self, *args)
    def unget(self) -> "std::basic_istream< char,std::char_traits< char > > &" : return inlib_swig_py.istream_unget(self)
    def sync(self) -> "int" : return inlib_swig_py.istream_sync(self)
    def tellg(self) -> "std::basic_istream< char >::pos_type" : return inlib_swig_py.istream_tellg(self)
    def seekg(self, *args) -> "std::basic_istream< char,std::char_traits< char > > &" : return inlib_swig_py.istream_seekg(self, *args)
...
class sf_enum_marker_tyle(object):
    ...
    def value(self, *args) -> "void" : return inlib_swig_py.sf_enum_marker_tyle_value(self, *args)
