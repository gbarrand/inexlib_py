...
class sg_colored_sized_points(sg_vertices):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def copy(self) -> "inlib::sg::node *" : return inlib_swig_py.sg_colored_sized_points_copy(self)
    __swig_destroy__ = inlib_swig_py.delete_sg_colored_sized_points
    __del__ = lambda self : None;
    def __init__(self, *args): 
        this = inlib_swig_py.new_sg_colored_sized_points(*args)
        try: self.this.append(this)
        except: self.this = this
    rgbas = _swig_property(inlib_swig_py.sg_colored_sized_points_rgbas_get, inlib_swig_py.sg_colored_sized_points_rgbas_set)
    sizes = _swig_property(inlib_swig_py.sg_colored_sized_points_sizes_get, inlib_swig_py.sg_colored_sized_points_sizes_set)
    def add(self, *args) -> "void" : return inlib_swig_py.sg_colored_sized_points_add(self, *args)
    def clear(self) -> "void" : return inlib_swig_py.sg_colored_sized_points_clear(self)
sg_colored_sized_points_swigregister = inlib_swig_py.sg_colored_sized_points_swigregister
...
class gui_viewer(viewer):
    ...
    def view_all(self) -> "bool" : return inlib_swig_py.gui_viewer_view_all(self)
    ...
    def set_scene_clear_color(self, *args) -> "void" : return inlib_swig_py.gui_viewer_set_scene_clear_color(self, *args)
    def set_gui_clear_color(self, *args) -> "void" : return inlib_swig_py.gui_viewer_set_gui_clear_color(self, *args)
    def reset_camera(self) -> "void" : return inlib_swig_py.gui_viewer_reset_camera(self)
