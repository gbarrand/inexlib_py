...
if __name__ == "__main__":
  ...
  #print("df_all.count() : "+str(df_all.count()))  # should be 292781506
  #print(df_all.columns)
  # column names should be :
  #   size_true, position_x, redshift_true, position_y, dec, is_central, halo_id, ra, redshift, position_z
  ...
  df=df_all.select("position_x","position_y","position_z","ra","dec","redshift","halo_id")\
  ...
  for row in data:
    color_factor = (float(row[i_redshift])-redshift_min)/redshift_delta
