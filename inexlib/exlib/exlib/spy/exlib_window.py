...
class ios_base(object):
    ...
    def register_callback(self, *args): return exlib_window_swig_py.ios_base_register_callback(self, *args)
    def flags(self, *args): return exlib_window_swig_py.ios_base_flags(self, *args)
    def setf(self, *args): return exlib_window_swig_py.ios_base_setf(self, *args)
    def unsetf(self, *args): return exlib_window_swig_py.ios_base_unsetf(self, *args)
    def precision(self, *args): return exlib_window_swig_py.ios_base_precision(self, *args)
    def width(self, *args): return exlib_window_swig_py.ios_base_width(self, *args)
    sync_with_stdio = staticmethod(exlib_window_swig_py.ios_base_sync_with_stdio)
    def imbue(self, *args): return exlib_window_swig_py.ios_base_imbue(self, *args)
    def getloc(self): return exlib_window_swig_py.ios_base_getloc(self)
    xalloc = staticmethod(exlib_window_swig_py.ios_base_xalloc)
    def iword(self, *args): return exlib_window_swig_py.ios_base_iword(self, *args)
    def pword(self, *args): return exlib_window_swig_py.ios_base_pword(self, *args)
...
class ios(ios_base):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def rdstate(self): return exlib_window_swig_py.ios_rdstate(self)
    def clear(self, *args): return exlib_window_swig_py.ios_clear(self, *args)
    def setstate(self, *args): return exlib_window_swig_py.ios_setstate(self, *args)
    def good(self): return exlib_window_swig_py.ios_good(self)
    def eof(self): return exlib_window_swig_py.ios_eof(self)
    def fail(self): return exlib_window_swig_py.ios_fail(self)
    def bad(self): return exlib_window_swig_py.ios_bad(self)
    def exceptions(self, *args): return exlib_window_swig_py.ios_exceptions(self, *args)
    def __init__(self, *args): 
    ...
    __del__ = lambda self : None;
    def tie(self, *args): return exlib_window_swig_py.ios_tie(self, *args)
    def rdbuf(self, *args): return exlib_window_swig_py.ios_rdbuf(self, *args)
    def copyfmt(self, *args): return exlib_window_swig_py.ios_copyfmt(self, *args)
    def fill(self, *args): return exlib_window_swig_py.ios_fill(self, *args)
    def imbue(self, *args): return exlib_window_swig_py.ios_imbue(self, *args)
    def narrow(self, *args): return exlib_window_swig_py.ios_narrow(self, *args)
    def widen(self, *args): return exlib_window_swig_py.ios_widen(self, *args)
...
class ostream(ios):
    ...
    __del__ = lambda self : None;
    def __lshift__(self, *args): return exlib_window_swig_py.ostream___lshift__(self, *args)
    def put(self, *args): return exlib_window_swig_py.ostream_put(self, *args)
    def write(self, *args): return exlib_window_swig_py.ostream_write(self, *args)
    def flush(self): return exlib_window_swig_py.ostream_flush(self)
    def tellp(self): return exlib_window_swig_py.ostream_tellp(self)
    def seekp(self, *args): return exlib_window_swig_py.ostream_seekp(self, *args)
...
class istream(ios):
    ...
    __del__ = lambda self : None;
    def __rshift__(self, *args): return exlib_window_swig_py.istream___rshift__(self, *args)
    def gcount(self): return exlib_window_swig_py.istream_gcount(self)
    def get(self, *args): return exlib_window_swig_py.istream_get(self, *args)
    def getline(self, *args): return exlib_window_swig_py.istream_getline(self, *args)
    def ignore(self, *args): return exlib_window_swig_py.istream_ignore(self, *args)
    def peek(self): return exlib_window_swig_py.istream_peek(self)
    def read(self, *args): return exlib_window_swig_py.istream_read(self, *args)
    def readsome(self, *args): return exlib_window_swig_py.istream_readsome(self, *args)
    def putback(self, *args): return exlib_window_swig_py.istream_putback(self, *args)
    def unget(self): return exlib_window_swig_py.istream_unget(self)
    def sync(self): return exlib_window_swig_py.istream_sync(self)
    def tellg(self): return exlib_window_swig_py.istream_tellg(self)
    def seekg(self, *args): return exlib_window_swig_py.istream_seekg(self, *args)
...
class sf_enum_marker_tyle(object):
    ...
    def value(self, *args): return exlib_window_swig_py.sf_enum_marker_tyle_value(self, *args)
